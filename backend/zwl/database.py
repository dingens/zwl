...
class Train(db.Model):
    ...
    transition_from_id = db.Column('uebergang_von_zug_id', db.Integer, db.ForeignKey('Train.id'))
    transition_to_id = db.Column('uebergang_nach_zug_id', db.Integer, db.ForeignKey('Train.id'))

    transition_from = db.relationship('Train', foreign_keys=transition_from_id, primaryjoin=transition_from_id==id, remote_side=id)
    transition_to = db.relationship('Train', foreign_keys=transition_to_id, primaryjoin=transition_to_id==id, remote_side=id)
